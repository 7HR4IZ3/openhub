  ...
  try {
    ...
    return {
      ...
      diff: {
        ...
        canonicalUrl: `https://github.com/${repository.fullName}/compare/${baseCommitSha}...${headCommitSha}`,
        licenseSpdxId: repository.licenseSpdxId ?? undefined,
        visibility: "public",
        baseSnapshot: baseFile?.text ?? "",
        headSnapshot: headFile?.text ?? "",
      },
      error: null,
    };
  } catch (error) {
...
function safeCommit(value: string | undefined) {
  return value !== undefined && /^[a-f0-9]{40}$/i.test(value) ? value : null;
}
