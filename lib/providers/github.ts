...
const capabilities: ProviderCapabilities = {
  ...
  releases: true,
  contributors: true,
  // The public adapter does not resolve a user-scoped GitHub token. Keeping
  // this false prevents callers from presenting public access as private ACL
  // support until that authorization path is implemented.
