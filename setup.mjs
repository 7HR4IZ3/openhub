 ...
 * environment variables for GitHub-only Convex Auth.
 *
...
const variables = JSON.stringify({
  help:
    "OpenHub uses GitHub OAuth for identity. " +
    "This command can help you configure the GitHub OAuth credentials " +
