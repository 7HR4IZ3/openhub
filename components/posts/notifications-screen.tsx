  ...
  return (
    ...
    >
      <div className="border-b border-black/[0.08] p-5 dark:border-white/[0.08] sm:p-7">
        <div className="flex items-start gap-3 rounded-2xl bg-[#e9e6dc] p-5 dark:bg-[#20251f]">
          <Sparkles className="mt-0.5 h-5 w-5 shrink-0 text-[#b45e3c] dark:text-[#e99970]" />
          <p className="text-sm leading-6 text-muted-foreground">Notifications stay focused on context: someone replied to your source, added a useful reaction, or continued a project trail you follow.</p>
        </div>
      </div>
...
function NotificationRow({
  ...
  const action = notification.type === "like" ? "liked your post" : notification.type === "comment" ? "added context to your post" : notification.type === "quote" ? "quoted your post" : "reposted your post";
